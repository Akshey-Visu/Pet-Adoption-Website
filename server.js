...
function verifyUser(username, password) {
    ...
    console.log(users); // Log the users array to see what is being checked
    return users.some(user => {
        const [storedUsername, storedPassword] = user.split(':');
        console.log(`Checking ${username} against ${storedUsername} and ${password} against ${storedPassword}`);
